...
## Information from ArchR Project
...
```{r}
p5 <- plotFragmentSizes(ArchRProj = ATACSeq_project)
p5
```
...
```{r}
p6 <- plotTSSEnrichment(ArchRProj = ATACSeq_project)
p6
```

Saving both these plots
```{r}
plotPDF(p5,p6, name = "QC-Sample-FragSizes-TSSProfile.pdf", ArchRProj = ATACSeq_project, 
